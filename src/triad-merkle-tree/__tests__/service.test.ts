...
describe('Generation, loading and compression of the Triad Merkle tree', () => {
    ...
    it('shoud be saved and loaded without compression', () => {
        ...
        fs.writeFileSync('src/triad-merkle-tree/__tests__/data/tree.txt', w, 'ucs2');

        const r = fs.readFileSync('src/triad-merkle-tree/__tests__/data/tree.txt', 'ucs2');
    ...
    it('shoud be saved and loaded with compression', () => {
        ...
        fs.writeFileSync('src/triad-merkle-tree/__tests__/data/tree_zip.txt', w, 'ucs2');

        const r = fs.readFileSync('src/triad-merkle-tree/__tests__/data/tree_zip.txt', 'ucs2');
