...
export const totalUnrealizedPrivacyRewardsTooltip =
    'Rewards will be “released” (i.e. available for exchange into $ZKP or other use) upon spending a zAsset inside the MASP. Reflected rewards are calculated at the projected APR. The parameter is to be defined by the community before the Core V1 launch and can be different.';
