...
export const env: EnvVariables = {
    ...
    VESTING_POOLS_CONTRACT_5: process.env.VESTING_POOLS_CONTRACT_5,
    ...
    REWARD_POOL_SIZE_5: process.env.REWARD_POOL_SIZE_5,
    ...
    STAKING_PROGRAM_DURATION_5: process.env.STAKING_PROGRAM_DURATION_5,
