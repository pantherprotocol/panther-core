...
> await test.init()
> await test.batchUnstake(test.stakesData)
*/
...
module.exports = (hre) => {
  ...
  async function init() {
    ...
    console.log('stakeRwdCtr.totalStaked: ', (await stakeRwdCtr.connect(deployer).totalStaked()).toString());
    console.log('staking.totalStaked:     ', (await staking.totalStaked()).toString());
    ...
    await rewardMaster
      ...
      console.log(
        ...
        await rewardMaster.connect(deployer).rewardAdvisers(_staking, actionStake)
      );

    console.log(
      'rewardMaster.rewardAdvisers.actionUnstake: ',
      await rewardMaster.connect(deployer).rewardAdvisers(_staking, actionUnstake)
    );
